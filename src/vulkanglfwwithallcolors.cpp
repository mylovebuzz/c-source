...
/*        for (auto imageView : swapChainImageViews) {
    ...
    void createInstance() {
       ...
       */
        ...
        if (enableValidationLayers) {
            std::cout << "in createInstance enableValidationLayers\n";
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        //std::cout << "imageIndex in recordCommandBuffer: " << imageIndex << std::endl;
        ...
        if (vkEndCommandBuffer(commandBuffer) != VK_SUCCESS) {
            throw std::runtime_error("failed to reocord command buffer !");
        }
    }
	...
	// must #include <limits> on ubuntu c++, not on windows visual studio
...
int main() {
    ...
    std::shared_ptr<int> p2(nullptr); std::cout << "p2 memory addr: " << &p2 << '\n';
    std::shared_ptr<int> p3(new int);           std::cout << "p3 value: " << *p3 << '\n';
    std::shared_ptr<int> p4(new int, deleter);
    std::shared_ptr<int> p5(new int(5), [](int* p) {std::cout << "p5 deleted called\n"; delete p;}, std::allocator<int>());
    std::shared_ptr<int> p6(p5);                            std::cout << "p6 value: " << *p6 << '\n';
    std::shared_ptr<int> p7(std::move(p6));
    std::shared_ptr<int> p8(std::unique_ptr<int>(new int));
    std::shared_ptr<C> obj(new C);                          std::cout << "obj value: " << 8 << '\n';
