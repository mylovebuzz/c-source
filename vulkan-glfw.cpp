...
*/
         ...
         */
            ...
            if (enableValidationLayers) { std::cout << "in createInstance enableValidationLayers\n";
...
*/
        ...
        bool checkValidationLayerSupport() {
            ...
            for (const char* layerName : validationLayers) {
                ...
                for (const auto& layerProperties : availableLayers) {std::cout << layerProperties.layerName << " found\n";
